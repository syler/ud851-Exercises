...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Log.d("my_app",String.format("the item id is %d, search id is %d",item_id,R.id.action_search));
        if(item_id == R.id.action_search){
            Toast.makeText(MainActivity.this,"Message displayed",Toast.LENGTH_LONG).show();
        }
